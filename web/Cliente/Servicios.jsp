    ...
    <body>
        ...
        <div class="text-dark text-center" id="firstSection"> 
            <div class="container py-5">
                    ...
                    <div class="container py-sm-5">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-lg-3 mb-5 mb-lg-0">
                                <i class="display-5 bi bi-shield-fill-plus text-danger"></i>
                ...
                <section id="consultaMedica" class="bg-gradient text-white text-center py-5" style="background:#92bcc2">
                    ...
                    <div class="container py-3">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 ">                   
                                <img class="img-fluid" src="https://images.unsplash.com/photo-1577175889968-f551f5944abd?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=870&q=80" width="500px"" alt="">                      
                            </div>
                            <div class="col-12 col-sm-6 ">
                ...
                <section id="Baño" class="bg-gradient text-white text-center py-5" style="background:#84da86">
                    <div class="container py-3">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 ">
                                <img src="https://images.unsplash.com/photo-1611173622933-91942d394b04?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=870&q=80" width="500px">
                            </div>
                            <div class="col-12 col-sm-6 ">
                                <!--icon <i> -->
                                <h5 class="mt-4"> La mejor atención la encuentras en nuestra veterinaria</h5>
                ...
                <section id="VacunasDesparacitacion" class="bg-gradient text-white text-center py-5" style="background:#92bcc2">
                    ...
                    <div class="container py-3">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 ">
                                <img src="https://www.zooplus.es/magazine/wp-content/uploads/2018/09/katzen-impfung-768x512.jpg" width="500px">
                            </div>
                            <div class="col-12 col-sm-6 ">
                                <!--icon <i> -->
                                <h5 class="mt-4"> La mejor atención la encuentras en nuestra veterinaria</h5>
                ...
                <section id="Cirugia" class="bg-gradient text-white text-center py-5" style="background:#84da86">
                    ...
                    <div class="container py-3">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 ">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Cirug%C3%ADa..jpg/1200px-Cirug%C3%ADa..jpg" width="500px">
                            </div>
                            <div class="col-12 col-sm-6 ">
                                <!--icon <i> -->
                                <h5 class="mt-4"> La mejor atención la encuentras en nuestra veterinaria</h5>
